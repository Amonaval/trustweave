...
const checks=[
 ...
 ['launch closure documentation exists',['LAUNCH-READINESS-REPORT.md','PILOT-DEMO-RUNBOOK.md','DATA-SEED-RUNBOOK.md','RUNTIME-VERIFICATION-CHECKLIST.md','FINAL-RELEASE-MANIFEST.md','RUNTIME-HOTFIX-APPLY-RUNBOOK.md','NEXT-SESSION-RUNTIME-HOTFIX-RETEST.md'].every(exists)],
