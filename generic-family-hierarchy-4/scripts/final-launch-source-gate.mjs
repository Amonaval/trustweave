...
const checks=[
 ...
 ['loader is only attached to persisted Residential / Family Community admin',template.includes('(kind==="housing-society"||kind==="family-association")&&<LaunchDemoDataLoader')&&template.includes('!demo')],
 ...
 ['launch closure documentation exists',['LAUNCH-READINESS-REPORT.md','PILOT-DEMO-RUNBOOK.md','DATA-SEED-RUNBOOK.md','RUNTIME-VERIFICATION-CHECKLIST.md','FINAL-RELEASE-MANIFEST.md','NEXT-SESSION-FINAL-RUNTIME-CERTIFICATION.md'].every(exists)],
