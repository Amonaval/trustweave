...
const checks=[
 ...
 ['launch closure documentation exists',['LAUNCH-READINESS-REPORT.md','PILOT-DEMO-RUNBOOK.md','DATA-SEED-RUNBOOK.md','RUNTIME-VERIFICATION-CHECKLIST.md','FINAL-RELEASE-MANIFEST.md','MISSION-1-RUNTIME-SEED-INTEGRITY-CLOSURE.md','MISSION-1-APPLY-RETEST-RUNBOOK.md','NEXT-SESSION-MISSION-2-SLOW-USER-REGRESSION.md'].every(exists)],
