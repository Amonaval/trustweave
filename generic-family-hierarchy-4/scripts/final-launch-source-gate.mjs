...
const checks=[
 ...
 ['launch closure documentation exists',['history/root-legacy/LAUNCH-READINESS-REPORT.md','history/root-legacy/PILOT-DEMO-RUNBOOK.md','history/root-legacy/DATA-SEED-RUNBOOK.md','history/root-legacy/RUNTIME-VERIFICATION-CHECKLIST.md','history/root-legacy/FINAL-RELEASE-MANIFEST.md','history/root-legacy/MISSION-1-RUNTIME-SEED-INTEGRITY-CLOSURE.md','history/root-legacy/MISSION-1-APPLY-RETEST-RUNBOOK.md','history/root-legacy/MISSION-2-SLOW-USER-REGRESSION-CLOSURE.md'].every(exists)],
