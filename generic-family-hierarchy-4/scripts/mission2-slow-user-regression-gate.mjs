...
ok('Mission 2 closure is recorded and Mission 3 is explicitly authorized',fs.existsSync('MISSION-2-CLOSURE-HANDOFF.md')&&read('MISSION-2-CLOSURE-HANDOFF.md').includes('paused/concluded for now')&&fs.existsSync('missions/mission-003/CHARTER.md')&&read('missions/mission-003/CHARTER.md').includes('Agentic Company & Engineering OS'));
