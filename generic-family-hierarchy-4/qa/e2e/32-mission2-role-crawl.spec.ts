...
import {login} from '../lib/login';import {activate,seedState} from '../lib/role-client';import {expertCrawl} from '../lib/crawler';import {mission2Watch} from '../lib/mission2-regression';import {expectedCrawlerTestIds} from '../runtime/catalog.mjs';
const verticals=['family','family-association','housing-society'] as const;const roles=['owner','admin','member'] as const;
