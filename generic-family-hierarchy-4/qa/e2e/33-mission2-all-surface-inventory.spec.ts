...
import {MISSION2_VERTICALS} from '../runtime/mission2-scope.mjs';
...
test.describe.serial('Mission 2 — every released vertical surface is reachable and inventoried',()=>{
 for(const vertical of MISSION2_VERTICALS)test(`${vertical.kind} owner traverses every instrumented navigation surface`,async({page},testInfo)=>{
